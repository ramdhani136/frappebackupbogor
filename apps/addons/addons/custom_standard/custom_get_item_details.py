...
def get_item_details(args, doc=None, for_validate=False, overwrite_warehouse=True):
	...
	if out.get("warehouse"):
		...
		if args["doctype"] == "Sales Order":
			out["net_stock_available"] = out["actual_qty"] - out["reserved_qty"]
...
def get_bin_details_and_serial_nos(item_code, warehouse, has_batch_no=None, stock_qty=None, serial_no=None):
	...
	# custom chandra
	bin_details_and_serial_nos["net_stock_available"] = float(bin_details_and_serial_nos["actual_qty"]) - float(bin_details_and_serial_nos["reserved_qty"])
