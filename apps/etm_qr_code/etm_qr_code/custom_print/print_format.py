...
from etm_qr_code.custom_print.pdf import get_pdf, cleanup
    ...
    if not isinstance(doctype, dict):
        ...
        for i, ss in enumerate(result):
            output = frappe.get_print(
                doctype, ss, format, as_pdf=True, output=output, no_letterhead=no_letterhead)
...
def print_by_server(doctype, name, print_format=None, doc=None, no_letterhead=0):
    ...
    try:
        ...
        output = frappe.get_print(doctype, name, print_format, doc=doc,
                                  no_letterhead=no_letterhead, as_pdf=True, output=output)
        file = os.path.join(
            "/", "tmp", "frappe-pdf-{0}.pdf".format(frappe.generate_hash()))
