...
{% include 'addons/public/js/custom_multi_select_dialog.js' %};
{% include 'addons/public/js/custom_map_current_doc.js' %};
...
erpnext.accounts.SalesInvoiceController = erpnext.selling.SellingController.extend({
	...
	delivery_note_btn: function() {
		...
		this.$delivery_note_btn = this.frm.add_custom_button(__('Delivery Note'),
			function() {
				erpnext.utils.map_current_doc_custom({
					...
					setters: {
						customer: me.frm.doc.customer || undefined,
						grand_total: me.frm.doc.grand_total || undefined
					},
					get_query: function() {
						var filters = {
							docstatus: 1,
						...
						return {
							query: "addons.custom_standard.custom_queries.get_delivery_notes_to_be_billed_custom",
							filters: filters
						};
					}
				});
